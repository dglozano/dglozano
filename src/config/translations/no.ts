const no = {
  translation: {
    ...
    letsTalk: "Ta kontakt.",
    send: "Send",
    letsTalkText: `Ikke nøl med å <1><0>sende meg en e-post</0></1>, legge meg til på <3><0>sosiale medier</0></3>  eller fylle ut dette skjemaet så kommer jeg tilbake til deg.`,
    email: "E-post",
    name: "Navn",
    message: "Melding",
